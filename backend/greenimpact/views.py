...
def start(request):
    ...
    while (len(ids) < 8):
        ...
        with connection.cursor() as cursor:
            ...
            query = "SELECT titre, categorie_id, id FROM greenimpact_question WHERE categorie_id = %s ORDER BY RANDOM() LIMIT 1"
            ...
            if row[2] not in ids:
                ...
                query = "SELECT texte_option, valeur_carbone FROM greenimpact_option WHERE id IN (SELECT option_id FROM greenimpact_question_option WHERE question_id = %s);"
